    ...
    return (
        ...
        >
            ...
            >
                ...
                <ul className="mt-5 grid gap-2 sm:grid-cols-2" aria-label="이번 내전 참여자">
                        ...
                        return (
                            <li key={candidate.id}>
                                <button
                                    ...
                                    className={`flex min-h-12 w-full items-center gap-3 rounded-xl border px-3 py-2 text-left text-sm transition disabled:cursor-wait ${
                                        isSelected
