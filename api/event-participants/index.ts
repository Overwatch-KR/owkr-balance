...
import { getEventParticipation, saveEventParticipation } from '../_lib/event-participant-store.js';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    try {
        ...
        if (req.method === 'PATCH') {
            ...
            const snapshot = await saveEventParticipation(redis, scrims, body?.participantIds);
            return snapshot
